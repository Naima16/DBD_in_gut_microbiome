...
data_directory = os.path.expanduser("~/dbd/data/")
data_rarefied_directory = os.path.expanduser("~/dbd/data_rarefied/")
int_data_directory = os.path.expanduser("~/glab/metagenomic_fastq_files/HMP1-2/midas_output_rarefied_v2")
metadata_directory = os.path.expanduser("~/dbd/scripts/metadata/")
analysis_directory = os.path.expanduser("~/dbd/analysis/")
scripts_directory = os.path.expanduser("~/dbd/scripts/")
