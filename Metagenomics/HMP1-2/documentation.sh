...
scripts_dir=/u/project/ngarud/daisyche/dbd/scripts
...
# For this dataset, there are 158 species with SNP information

ls $genes_dir > $genes_dir/species_genes.txt

# Manually remove non-species filenames from this list
# For this dataset, there are 194 species with gene information
...
python $scripts_dir/postprocess/core_gene_utils.py
