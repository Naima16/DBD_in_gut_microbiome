...
output_filename = ('%s/within_host_output.txt' % (config.analysis_directory))
output_strs = []
...
pickle.dump(species_snp_change_distribution, open('%s/pickles/species_snp_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(species_snp_nerrs, open('%s/pickles/species_snp_nerrs.pkl' % config.data_directory, 'wb'))
pickle.dump(species_gene_change_distribution, open('%s/pickles/species_gene_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(species_gene_nerrs, open('%s/pickles/species_gene_nerrs.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_snp_change_distribution, open('%s/pickles/pooled_snp_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_gene_change_distribution, open('%s/pickles/pooled_gene_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_snp_length_distribution, open('%s/pickles/pooled_snp_length_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_gene_length_distribution, open('%s/pickles/pooled_gene_length_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_between_snp_change_distribution, open('%s/pickles/pooled_between_snp_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_between_gene_change_distribution, open('%s/pickles/pooled_between_gene_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_min_between_snp_change_distribution, open('%s/pickles/pooled_min_between_snp_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(pooled_min_between_gene_change_distribution, open('%s/pickles/pooled_min_between_gene_change_distribution.pkl' % config.data_directory, 'wb'))
pickle.dump(replacement_map, open('%s/pickles/replacement_map.pkl' % config.data_directory, 'wb'))
pickle.dump(total_freq_snps, open('%s/pickles/total_freq_snps.pkl' % config.data_directory, 'wb'))
pickle.dump(total_null_freq_snps, open('%s/pickles/total_null_freq_snps.pkl' % config.data_directory, 'wb'))
...
fig2.savefig('%s/figure_5.pdf' % (config.analysis_directory),bbox_inches='tight')
fig.savefig('%s/supplemental_within_across_species.pdf' % (config.analysis_directory),bbox_inches='tight')
sys.stderr.write("Done!\n")
fig3.savefig('%s/supplemental_young_twin_within.pdf' % (config.analysis_directory),bbox_inches='tight',transparent=True)
fig4.savefig('%s/supplemental_within_between_avg.pdf' % (config.analysis_directory),bbox_inches='tight',transparent=True)
...
fig8.savefig('%s/supplemental_within_across_species.pdf' % (config.analysis_directory),bbox_inches='tight',transparent=True)
fig9.savefig('%s/supplemental_within_ks.pdf' % (config.analysis_directory),bbox_inches='tight',transparent=True)
fig10.savefig('%s/supplemental_sites_retained.pdf' % (config.analysis_directory),bbox_inches='tight',transparent=True)
