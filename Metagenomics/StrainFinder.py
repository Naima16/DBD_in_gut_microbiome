...
def parse_args():
    ...
    group3.add_argument('--s_reps', help='Number of searches (shallow)', type=int, default=sysmaxint)
    group3.add_argument('--s_iter', help='Number of iterations (shallow)', type=int, default=sysmaxint)
    group3.add_argument('--d_reps', help='Number of searches (deep)', type=int, default=0)
    group3.add_argument('--d_iter', help='Number of iterations (deep)', type=int, default=sysmaxint)
...
class EM():
    ...
    def shallow_search(self, n, n_reps=sysmaxint, n_iter=sysmaxint, n_keep=None, c=None, exhaustive=False, random=False, robust=False, penalty=None, dtol=None, ftol=None, ntol=None, max_reps=sysmaxint, max_time=sysmaxint, log_fn=None, out_fn=None):
    ...
    def deep_search(self, n, n_reps=1, n_iter=sysmaxint, n_keep=None, c=None, exhaustive=False, dtol=None, ftol=None, ntol=None, max_time=sysmaxint, log_fn=None, out_fn=None):
