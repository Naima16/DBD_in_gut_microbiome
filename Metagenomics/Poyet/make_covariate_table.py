...
# Original number of reads (from FASTQ) EXCLUDED
...
output_file = open("%s/Poyet_sample_covariates.txt" % config.analysis_directory, 'w')
fields = ["sample_id", "subject_id", "shannon_diversity", "species_richness", "total_reads_MIDAS", "total_avg_marker_coverage", "total_med_marker_coverage"]
...
for sample in samples:	
	...
	field_data = [sample_no_c, sample_subject_map[sample_no_c], alpha_div_dict[sample], richness_dict[sample], read_count_dict[sample], total_avg_marker_cov_dict[sample], total_med_marker_cov_dict[sample]]
