...
rarefied_data_dir = "/u/home/d/daisyche/dbd/data_poyet_rarefied_5m"
...
# Relative abundance file (original)
...
# Relative abundance file (rarefied to 5 million)
...
with open("%s/Poyet_temporal_changes_diversity.csv" % analysis_dir, 'w') as outfile:
	fields = ','.join('sample_tp1 sample_tp2 qp_status subject species num_SNP_changes num_gene_gains num_gene_losses alpha_div_tp1 alpha_div_tp2 richness_tp1 richness_tp2 polymorphism_tp1 polymorphism_tp2 num_strains_cov0_tp1 num_strains_cov0_tp2 num_strains_cov10_tp1 num_strains_cov10_tp2'.split())
	...
	for sample_i, sample_j in snp_change_dict:
		for species in snp_change_dict[(sample_i, sample_j)]:
			...
			try:
				num_strains_cov0_tp1 = strain_num_dict[sample_i][species]
				num_strains_cov0_tp2 = strain_num_dict[sample_j][species]
				num_strains_cov10_tp1 = strain_num_cov10_dict[sample_i][species]
				num_strains_cov10_tp2 = strain_num_cov10_dict[sample_j][species]
			except:
				print("Missing strain info for %s %s %s" % (sample_i, sample_j, species))
				continue
			
			fields_data = [sample_i, sample_j, qp_status, subject, species, num_SNP_changes, num_gene_gains, num_gene_losses, adiv_tp1, adiv_tp2, richness_tp1, richness_tp2, polymorphism_tp1, polymorphism_tp2, num_strains_cov0_tp1, num_strains_cov0_tp2, num_strains_cov10_tp1, num_strains_cov10_tp2]
