...
data_directory = os.path.expanduser("~/dbd/data_poyet/")
int_data_directory = os.path.expanduser("~/glab/metagenomic_fastq_files/Poyet/midas_output")
metadata_directory = os.path.expanduser("~/dbd/scripts_poyet/metadata/")
analysis_directory = os.path.expanduser("~/dbd/analysis/poyet/")
scripts_directory = os.path.expanduser("~/dbd/scripts_poyet/")
